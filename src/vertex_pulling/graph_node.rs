...
impl Node for MainPass3dNode {
    ...
    fn run(
        ...
        let (camera, opaque_phase, alpha_mask_phase, transparent_phase, camera_3d, target, depth, gbuffer) =
        ...
        // Always run opaque pass to ensure screen is cleared
        {
            ...
            let pass_descriptor = RenderPassDescriptor {
                ...
                color_attachments: &[
                    ...
                    Some(gbuffer.get_color_attachment(Operations {
                        load: LoadOp::Clear(Color::RgbaLinear { red: 0.0, green: 0.0, blue: 0.0, alpha: 0.0 }),
                        store: true,
                    })),
                ],
